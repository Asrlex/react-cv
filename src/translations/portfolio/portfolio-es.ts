...
const portfolioEs: ProjectInformation[] = [
  {
  ...
  },
  {
    ...
    type: 'API REST',
    description: 'Clúster de servicios políglota en Spring, Typescript y Go.',
    features: [
      'AaaS (Authentication as a Service) y gestión de usuarios en Spring Boot con JWT, ApiKey y OAuth2',
      'Notification dispatcher en NestJS',
      'Email dispatcher en NestJS con Nodemailer y servidor SMTP con Postfix',
      'Scheduler service en Go',
      'Registro de servicios en Go',
      'API REST Gateway en Spring Boot',
      'API REST de gestión de hogar en Spring Boot',
      'Webapp en React para gestión de hogar',
      'Gestión y almacenamiento de archivos en NestJS',
      'Despliegue en Docker Compose con dockernet común',
      'Infraestructura común con Redis, PostgreSQL, Prometheus y Kafka',
    ],
