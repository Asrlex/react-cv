...
const portfolioEn: ProjectInformation[] = [
  {
  ...
  },
  {
    ...
    name: 'Personal MS Cluster',
    type: 'API REST',
    description: 'Polyglot microservices cluster with Spring, Typescript and Go.',
    features: [
      'AaaS (Authentication as a Service) and user management on SpringBoot with JWT, Api Key and OAuth2',
      'Notification dispatcher in NestJS',
      'Email dispatcher in NestJS with Nodemailer and SMTP server with Postfix',
      'Scheduler service in Go',
      'Service registry in Go',
      'API REST Gateway in Spring Boot',
      'API REST for home management in Spring Boot',
      'Webapp in React for home management',
      'File management and storage in NestJS',
      'Deployment in Docker Compose with common dockernet',
      'Common infrastructure with Redis, PostgreSQL, Prometheus and Kafka',
    ],
